...
export const tools: Tool[] = [
  ...
  { id: 31, slug: 'image-ocr', name: 'OCR Image', description: 'AI-powered OCR — handwriting, tables, IDs, 150+ languages, batch export & live preview — 100% private', category: 'image', icon: 'scan-text', badge: 'popular', runner: 'ocr', mode: 'image', accept: 'image/*,.jpg,.jpeg,.png,.webp,.heic,.heif,.avif,.bmp,.gif,.tiff,.tif,.svg,.pdf', multiple: true, keywords: ['ocr', 'image ocr', 'text extraction', 'handwriting ocr', 'scan text', 'bengali ocr', 'hindi ocr', 'table ocr', 'business card ocr', 'aadhaar ocr', 'invoice ocr'] },
  ...
  { id: 59, slug: 'ai-presentation-maker', name: 'AI Presentation Maker', description: 'Generate, edit, theme, present & export AI decks to PPTX', category: 'ai', icon: 'presentation', badge: 'ai', runner: 'presentation', mode: 'pptx' },
