import type { ToolSeoOverride } from '@/lib/seo';

/**
 * Per-tool SEO overrides — the single, data-driven source of hand-tuned SEO copy.
 *
 * Keyed by tool `slug`. Every field is optional; anything you omit falls back to
 * the generated default in `lib/seo.ts`, so a tool listed here with only a `faq`
 * still gets an auto-generated title, description, keywords and HowTo. Tools NOT
 * listed here are fully covered by the generated defaults — they still emit a
 * complete SoftwareApplication + HowTo + FAQPage + BreadcrumbList schema.
 *
 * To enrich a tool: add (or extend) its entry below. Nothing else needs editing —
 * `app/tools/[category]/[tool]/page.tsx` reads everything from here.
 */
export const toolSeoContent: Record<string, ToolSeoOverride> = {
  'pdf-converter': {
    title: 'PDF Converter - Convert PDF to Word, Excel, JPG & More Free | Farvixo Tools',
    description:
      'Convert PDF to Word, Excel, PowerPoint, JPG, or convert any file to PDF - free, fast, and secure. No signup required. 100% browser-based processing.',
    trustExtra: 'Files auto-deleted after 24h',
    howTo: [
      { name: 'Upload your file', text: 'Drag & drop your PDF or source file, or click to browse. Nothing is uploaded to any server — conversion runs 100% in your browser.' },
      { name: 'Pick your target format', text: 'Choose PDF to Word, Excel, PowerPoint, JPG, PNG, TXT, HTML or Markdown — or convert any file to PDF. Set your options and click Convert.' },
      { name: 'Download your converted file', text: 'Download instantly. Convert to another format without re-uploading — free, unlimited and with no watermark.' },
    ],
    faq: [
  ...
  'pan-card-photo-resizer': {
    ...
    description:
      'Free AI PAN card photo, signature & document resizer for NSDL (Protean) and UTIITSL. Auto face crop, white background, DPI fix, 12-point compliance validator. 100% private.',
    trustExtra: 'AI Face Crop · 12-Point Compliance',
    faq: [
  ...
  'image-compressor': {
    ...
    description:
      'Compress images up to 90% smaller with AI-powered optimization. Supports AVIF, WebP, JPEG, PNG. Batch processing, target file size, social media presets. 100% private — runs in your browser.',
    trustExtra: '100% Private · No Upload',
    faq: [
  ...
  'video-converter': {
    ...
    description:
      'Convert videos to MP4, WebM, MKV, MOV, GIF or extract MP3/AAC. AI smart analysis, social presets (YouTube, Instagram, TikTok), batch queue, trim & rotate. 100% private FFmpeg in your browser.',
    trustExtra: 'FFmpeg WASM · AI Analysis · Batch',
    faq: [
  ...
  'audio-converter': {
    ...
    description:
      'Convert audio to MP3, WAV, FLAC, AAC, OGG, OPUS with AI analysis, noise removal, podcast presets, waveform preview & batch queue. 100% private FFmpeg in your browser.',
    trustExtra: 'AI Analysis · Waveform · Spectrum · Merge',
    faq: [
  ...
  'pdf-to-word': {
    ...
    description:
      'Convert PDF to editable DOCX with AI layout repair, table detection, Bengali/Hindi OCR, batch mode & confidence score. 100% private browser processing — better than iLovePDF for Indian documents.',
    trustExtra: 'AI Indic Repair · Confidence Score',
    faq: [
  ...
  'compress-pdf': {
    ...
    description:
      'Compress PDF files up to 90% smaller with AI smart modes — email, web, print, lossless. Batch queue, compression report, password PDF support. Free & 100% private.',
    trustExtra: 'AI Smart Modes · Batch Queue',
    faq: [
  ...
  'background-remover': {
    ...
    description:
      'Remove image backgrounds with AI — hair refinement, erase/restore brush, 14 background presets, batch ZIP export. Free, unlimited, 100% browser-private.',
    trustExtra: 'AI Hair Refine · 100% Private',
    faq: [
  ...
  'merge-pdf': {
    ...
    description:
      'Merge multiple PDFs with AI page analysis, drag reorder, optimize modes for PAN/passport/book, batch merge. Free & 100% private browser processing.',
    trustExtra: 'AI Organize · 10 Merge Modes',
    faq: [
  ...
  'image-to-pdf': {
    ...
    description:
      'Convert JPG, PNG, WEBP, HEIC to PDF with AI analysis, drag timeline, page size control, compression, watermark & password. Free, 100% private browser processing.',
    trustExtra: 'AI Analysis · Drag Timeline · Batch',
    faq: [
  ...
  'ai-chat': {
    ...
    description:
      'Free advanced AI chat powered by Gemini — General, Code, Creative, Analyst, Teacher modes. Chat history, PDF attach, temperature control, export & regenerate.',
    trustExtra: '6 Personas · Chat History · Streaming',
    faq: [
  ...
  'ai-pdf-assistant': {
    ...
    description:
      'Upload any PDF and ask questions — summaries, key facts, tables, action items. Powered by Gemini with streaming answers. Free & private.',
    trustExtra: 'PDF Q&A · Summarize · Extract',
    faq: [
  ...
  'age-calculator': {
    ...
    description:
      'Calculate your exact age with leap-year accuracy. Birthday countdown, zodiac sign, milestones, life statistics, AI insights. 100% free, private, runs in your browser.',
    trustExtra: 'Live Ticking · Zodiac · Milestones · AI',
    faq: [
  ...
  'world-weather-pro': {
    title: 'World Weather Pro — Live Weather, 14-Day Forecast, AQI & Radar Map | Farvixo Tools',
    description:
      'Free live weather app: real-time conditions, hourly timeline, 7 & 14-day forecast, air quality index, interactive radar map, sunrise/sunset, moon phase and AI insights for any city worldwide. No API key, no signup, 100% private.',
    ogSubtitle: 'Live forecast, AQI & radar',
    trustExtra: 'Live · 14-Day · AQI · Radar · No Signup',
    keywords: [
...
/** Resolve the hand-tuned SEO override for a tool slug, if one exists. */
export function getToolSeo(slug: string): ToolSeoOverride | undefined {
